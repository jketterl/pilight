...
if __name__ == '__main__':
    ...
    ShowButtonMapping(bank.universe[8], showManager, 'colorfaderpixel', bank.out[0])
    ShowButtonMapping(bank.universe[9], showManager, 'snowpixel', bank.out[1])
    ShowButtonMapping(bank.universe[10], showManager, 'twinklepixel', bank.out[2])
    ShowButtonMapping(bank.universe[11], showManager, 'bpmstrobe', bank.out[3])
    ShowButtonMapping(bank.universe[12], showManager, 'police', bank.out[4])
